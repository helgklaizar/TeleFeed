...
const translations = {
    en: {
        ...
        aiChatGreeting: 'Hi! I am the TeleFeed AI assistant. How can I help?',
    ...
    ru: {
        ...
        aiChatGreeting: 'Привет! Я AI-ассистент TeleFeed. Чем могу помочь?',
